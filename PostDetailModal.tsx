...
import type { ScheduledPost, Account } from './types.tsx';
...
export const PostDetailModal: React.FC<PostDetailModalProps> = ({ post, account, onClose, onUnschedule }) => {
    if (!post) return null;
        ...
        <div className="post-detail-modal" onClick={onClose}>
            <div className="modal-content" onClick={e => e.stopPropagation()}>
                ...
                <div className="modal-header">
                    ...
                    <p className="modal-subtitle">Scheduled for {new Date(post.date + 'T' + post.time).toLocaleString([], { dateStyle: 'medium', timeStyle: 'short' })}</p>
                </div>
