...
import { PostDetailModal } from './PostDetailModal.tsx';
...
export const CalendarDashboardView: React.FC<CalendarDashboardViewProps> = ({ scheduledPosts, onUnschedule, accounts }) => {
        ...
        <div className="calendar-dashboard">
            ...
            <div className="calendar-grid-container">
             ...
             {modalPost && (
                <PostDetailModal
                    post={modalPost}
                    account={accounts.find(a => a.name === modalPost.accountName)}
